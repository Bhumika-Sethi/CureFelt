    ...
    <>
      ...
      <div className={aboutstyles.aboutmain}>
        ...
        <div className={aboutstyles.fakeimg}>
          <b>Primary User:</b>
          <p>
            CureFelt tries to monitor mental health through well-detailed quizzes
          ...
          <p>
            ...
            related activities through the Events Section of CureFelt. To do this
        ...
        <h2>Guide for primary User</h2>
          ...
          <div className={aboutstyles.fakeimg}>
            <b>Quiz Page:</b>
            <p>
              CureFelt tries to monitor mental health through well-detailed
            ...
            <p>
              An Event Organizer can market virtual events, conferences and
              related activities through the Events Section of CureFelt.
            </p>
            <b>Need To Talk?:</b>
            <p>
